 ...
 */
	Configure::write('Security.salt', 'aa');
 ...
 */
    Configure::write('Authake.baseUrl', 'http://'. $_SERVER['HTTP_HOST']);   // set the full application url
/**
 *  Default login action
 */
    Configure::write('Authake.loginAction', '/authake/user/login');
/**
 * Session timeout in seconds, if managed by Authake (or null to disable)
 */
    //Configure::write('Authake.sessionTimeout', 60);
/**
 * Default page when access is denied (should be allowed by ACLs...)
 */
    Configure::write('Authake.defaultDeniedAction', '/authake/user/denied');
/**
 ...
 */
	...
	Configure::write('Authake.accessStorage', 'DB');

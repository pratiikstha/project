...
<div class="boxContent clearfix">
        ...
        <div class="menuContent">
        	<div class="contentList">
                <ul>
					...
					<br>
					<li><?php echo $this->Html->link(__("आम्दानी रसिद काट्नुहोस", true), array('controller' => 'day_books', 'action' => 'add')); ?></li>
				</ul>
			</div><!-- end contentList-->
		</div><!-- end menuContent-->
	</div><!-- end menu-->
        ...
        <div class="menuContent">
			<div class="contentList">
                <ul>
					...
					<br>
					<li><?php echo $this->Html->link(__("दैनिक आय शीर्षकगत कर संकलन खाता ", true), array('controller' => 'day_books', 'action' => 'index')); ?> </li>
	...
	<div class="menu fleft" style="width:190px">
        ...
        <div class="menuContent">
			<div class="contentList">
                <ul>
					<li><?php echo $this->Html->link(__(ADD . ' ' . CITIZEN . ' ' . RECORD, true), array('controller' => 'citizens', 'action' => 'add')); ?> </li>

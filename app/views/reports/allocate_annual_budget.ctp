			...
			<td>
				<div class="accounts index">
					...
					<?php foreach($budgets as $budget) {
							...
							$accountId = $budget['Account']['account_id'];
							$options['label'] = $budget['Account']['account_name'];
							$options['value'] = $nepaliNumber->toggleNumberLang($budget["Account"]["opening_balance"], 'nepali');
							echo $this->Form->input('budget_opening_balance_' . $accountId, $options);
					}
					?>
					...
					<tr>
						...
						<?php
							...
							$options['label'] = false;
							$options['value'] = $nepaliNumber->toggleNumberLang($accounts["Account"]["opening_balance"], 'nepali');

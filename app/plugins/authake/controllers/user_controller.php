...
class UserController extends AuthakeAppController {
  var $name       = 'User';
  var $uses       = array('Authake.User', 'Authake.Permission', 'Authake.Group');
  var $components = array('Email', 'Authake.Authake');
  var $helpers    = array('Html', 'Form', 'Authake.Authake');
   ...
   */
    function login(){
    	$this->layout = '';
    	$this->set("title_for_layout","लगइन"); 
